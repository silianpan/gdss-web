  ...
  <div class="bio-s-wrapper fh" @keyup.enter="handleSearch">
    <div style="padding-bottom:8px;">
      <Breadcrumb>
        ...
        <BreadcrumbItem>生物医药</BreadcrumbItem>
      </Breadcrumb>
    </div>
    <div class="s-input-wrapper bg-white">
      <div>
        ...
        <Tooltip content="在精确搜索时请按照'产品名称'，'批准文号/注册证号'，'药品本位码'，'生产厂商'的顺序来进行单个或组合查询，组合中间请用';'隔开，所有的输入内容请均完整输入" placement='right' theme='dark' max-width='200'>
    ...
    <div class="s-condition-wrapper hc-mt-10 bg-white">
      <div class="hc-tabs-wrapper">
        <Tabs type="card" v-model="curTab" @on-click="handleTabClick">
          <TabPane label="国产药品" name="DrugChina"></TabPane>
          <TabPane label="进口药品" name="DrugImport"></TabPane>
        </Tabs>
      </div>
    </div>
...
<script>
import DrugChina from './china/table-page'
import DrugImport from './import/table-page'
export default {
  mixins: [],
  components: {
    DrugChina,
