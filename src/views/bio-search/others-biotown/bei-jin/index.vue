  ...
  <div class="bio-s-wrapper fh" @keyup.enter="handleSearch">
    <div style="padding-bottom:8px;">
      <div class="ivu-breadcrumb">
        <span>
          <a href="#/search" target="_self" class="ivu-breadcrumb-item-link">首页
          </a>
          <span class="ivu-breadcrumb-item-separator">&gt;</span>
        </span>
        <span>
          <span v-if="!activedBio || $_.isEmpty(activedBio)" class="ivu-breadcrumb-item-link">其他生物城</span>
          <a v-else @click="activedBio = {}" target="_self" class="ivu-breadcrumb-item-link">其他生物城
          </a>
          <span class="ivu-breadcrumb-item-separator">&gt;</span>
        </span>
        <span v-if="activedBio && !$_.isEmpty(activedBio)">
          <span class="ivu-breadcrumb-item-link">{{ activedBio.name }}</span>
          <span class="ivu-breadcrumb-item-separator">&gt;</span>
        </span>
      </div>
    </div>
      ...
      <!-- <div class="s-content-wrapper bg-white">
        <div class="content-list-wrapper">
          ...
          >
            ...
            <div style="width:100%;">
              <div
                class="hc-show-row-1 content-list-item-title "
              ...
              <div
                class=" hc-pd-16 hc-border content-list-item-content hc-mt-8"
              >
