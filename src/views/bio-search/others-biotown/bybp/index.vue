  ...
  <div class="bio-s-wrapper fh" @keyup.enter="handleSearch">
    <div style="padding-bottom:8px;">
      <Breadcrumb>
        ...
        <BreadcrumbItem>北京亦庄生物医药园</BreadcrumbItem>
      </Breadcrumb>
    </div>
    ...
    >
      ...
      <div class="s-content-wrapper bg-white">
        <div class="content-list-wrapper hc-pd-16">
          ...
          >
            <NewsItem :data="r" v-if="['notice', 'news', 'memorabilia', 'policy'].indexOf(r.classify) > -1" />
            <CompanyItem :data="r" v-if="r.classify === 'enterprise'" />
          </div>
        </div>
      </div>
    </div>
