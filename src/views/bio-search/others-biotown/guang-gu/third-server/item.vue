  ...
  <div class="item-wrapper">
    <div style="flex: 1 auto;">
      <div class="item-title-wrapper">
        <div class="item-classify hc-mr-16">
          {{ `${data.classify_name} - ${others.third_server}` }}
        </div>
        <div
      ...
      <div class="  hc-pd-16 hc-border content-list-item-content hc-mt-8">
        <div style="display:flex;  align-items: center;justify-items: center;">
          ...
          <div style="flex:1">
            <div><b>联系电话：</b>{{ others.telephone }}</div>
            <div><b>服务内容：</b>{{ others.server_content }}</div>
      ...
      const drawer = this.$ddr.create(
        {
          width: '60%',
          components: {},
          render: <Detail url={this.data.json_url}></Detail>
        },
        this
      )
      drawer.show()
