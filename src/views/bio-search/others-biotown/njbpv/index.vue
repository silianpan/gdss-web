  ...
  <div class="bio-s-wrapper fh" @keyup.enter="handleSearch">
    <div style="padding-bottom:8px;">
      <Breadcrumb>
        ...
        <BreadcrumbItem>南京生物医药谷</BreadcrumbItem>
      </Breadcrumb>
    </div>
    ...
    >
      ...
      <div class="s-content-wrapper bg-white">
        <div class="content-list-wrapper hc-pd-16">
          ...
          >
            <YqnkItem v-if="r.classify === 'yqnk'" :data="r"></YqnkItem>
            <NewsItem v-else :data="r"></NewsItem>
          </div>
        </div>
      </div>
    </div>
...
import YqnkItem from './yuan-qu-nei-kan/item'
export default {
  mixins: [TableMixin],
  components: {
    SearchForm,
